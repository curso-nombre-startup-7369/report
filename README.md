...
|----------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
| <img src="/RUTA DE LA IMAGEN" alt="NOMBRE DE LA FOTO" height="150" /> <br> Apellidos y Nombres<br> CODIGO                                                                |  DESCRIPCION ALUMNO                                                                                                                                                                   | CONOCIMIENTOS DEL ALUMNO                                                                          |
| <img src="/RUTA DE LA IMAGEN" alt="NOMBRE DE LA FOTO" height="150" /> <br> Apellidos y Nombres<br> | DESCRIPCION ALUMNO   | CONOCIMIENTOS DEL ALUMNO  |
| (foto) <br> nombres apellidos <br> codigo                                                                                  | descripcion                                                                                                                                                                                                                                                | conocimientos                                                                                   |
| (foto) <img src="/RUTA DE LA IMAGEN" alt="NOMBRE DE LA FOTO" height="150" /> <br> Apellidos y Nombres<br>                                                                | DESCRIPCION ALUMNO  | CONOCIMIENTOS DEL ALUMNO |
| (foto) <br> nombres apellidos <br> codigo                                                                                  | descripcion                                                                                                                                                                                                                                                | conocimientos                                                                                   |
...
<img alt="upc-logo" src="/assets/img/Lean UX Canvas.png" width="100%"/>
